...
for($j=0;$j<4;$j++) :
		...
		<div class="col-md-3 portfolio-item">
			...
			<a href="prodotto/generale/prod1"><img class="img-responsive" src="<?=curURL() ?>images/modello.png"></a>
			<div class="row">
				<div class="col-md-9 col-lg-9">
					Nome modello
				</div>
				<div class="col-md-3 col-lg-3" style="font-size: 20px;">
					<a class="gallery-lightbox" href="#"><span class="glyphicon glyphicon-zoom-in"></span></a>
				</div>
			</div>
		</div>
			...
			<div class="modal-body" style="height: 100%;">
				...
				<div id="carousel-generic" class="carousel slide">
					...
					<div class="carousel-inner">
						...
						<div class="item">
							<img style="width:100%;" class="img-responsive" src="http://lorempixel.com/400/200/sports/" />
						</div>

						<div class="item">
							<img style="width:100%;" class="img-responsive" src="http://lorempixel.com/g/400/200/" />
