...
<html lang="en">
	<head>
		...
		<link href="<?=curURL()?>css/prettify.css" type="text/css">
		<link href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/css/bootstrap-combined.no-icons.min.css" rel="stylesheet">
		<link href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/css/bootstrap-responsive.min.css" rel="stylesheet">
		<link href="http://netdna.bootstrapcdn.com/font-awesome/3.0.2/css/font-awesome.css" rel="stylesheet">
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
		<script src="<?=curURL()?>js/jquery.hotkeys.js"></script>
		<script src="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.1/js/bootstrap.min.js"></script>
		<script src="<?=curURL()?>js/prettify.js" type="text/javascript"></script>

		<link href="<?=curURL()?>css/modern-business.css" rel="stylesheet">
		<script type="text/javascript" src="<?=curUrl() ?>js/bootstrap-wysiwyg.js"></script>
	</head>
	<body>
			...
			<div class="row">
				<div class="span6">
					...
					<p>
						...
						rich-content editor, inspired by <a href="http://premiumsoftware.net/cleditor/">CLEditor</a> and <a href="http://jhollingworth.github.com/bootstrap-wysihtml5/">bootstrap-wysihtml5</a>.
					...
					<ul>
						...
						<li>
							Uses standard browser features, no magic non-standard code, toolbar and keyboard configurable to execute any <a href="https://developer.mozilla.org/en/docs/Rich-Text_Editing_in_Mozilla">supported browser command</a>
						</li>
						<li>
					...
					<p>
						...
						turn out to be much worse than standard Bootstrap buttons.
					</p>
					<p>
						It turns out, with HTML5, everything we need can fit into less than 5K. We built this tiny tiny editor that does everything we need, does not impose
						any particular additional CSS and uses modern browser functionality without reimplementing jQuery and Bootstrap.
					</p>
					<p>
 ...
 #editor {overflow:scroll; max-height:300px}
					...
					<p>
						If you want to use this for a mobile web site, make sure to read about <a href="https://github.com/mindmup/bootstrap-wysiwyg#styling-for-mobile-devices">how to style it</a> to optimise mobile screen usage and experience (please note that this
						demo page isn't optimised for mobile access).
					</p>
...
&lt;/div&gt; 
  ...
  &lt;a data-edit="bold"&gt;...&lt;/a&gt;
					...
					<p>
						execute more complex commands by adding an argument after a blank or providing an input with a data-edit command (the input value is used as an argument). In case of
						file inputs, the file contents are read in using the FileReader API and used as the command value.
					<p>
						<pre class="prettyprint linenums">
