...
$(document).ready(function() {
	...
	*/
	...
	$('.col-md-3 a img').each(function(index, image) {
		...
		$('<div class="item"><img class="img-responsive" data-path="' + $(this).data("path") + '" alt="' + $(this).attr("alt") + '" src="' + image_path + '" data-id="' + $(this).data("id") + '"/></div>').appendTo('.modal-body .carousel-inner');
	...
	$('.gallery-lightbox').click(function() {
		...
		$('.modal-title').html('<a href="' + $(active_image).data("path") + '">' + $(active_image).attr("alt") + '</a>');
