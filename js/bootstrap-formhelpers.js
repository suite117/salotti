...
var BFHMonthsList = [ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August',
...
var BFHGoogleFontsList = {
  ...
  'items' : [
	  ...
	  },
	  {
		'kind' : 'webfonts#webfont',
		'family' : 'Cabin',
		'variants' : [ 'regular', 'italic', '500', '500italic', '600', '600italic', '700',
			'700italic' ],
		'subsets' : [ 'latin' ]
	  },
	  {
	  ...
	  },
	  {
		'kind' : 'webfonts#webfont',
		'family' : 'Exo',
		'variants' : [ '100', '100italic', '200', '200italic', '300', '300italic', 'regular',
			'italic', '500', '500italic', '600', '600italic', '700', '700italic', '800',
	  ...
	  },
	  {
		'kind' : 'webfonts#webfont',
		'family' : 'Josefin Sans',
		'variants' : [ '100', '100italic', '300', '300italic', 'regular', 'italic', '600',
	  ...
	  },
	  {
		'kind' : 'webfonts#webfont',
		'family' : 'Open Sans',
		'variants' : [ '300', '300italic', 'regular', 'italic', '600', '600italic', '700',
			'700italic', '800', '800italic' ],
		'subsets' : [ 'cyrillic', 'greek-ext', 'latin-ext', 'latin', 'vietnamese', 'greek',
			'cyrillic-ext' ]
	  },
	  {
		'kind' : 'webfonts#webfont',
	  ...
	  },
	  {
		...
		'variants' : [ '200', '200italic', '300', '300italic', 'regular', 'italic', '600',
			'600italic', '700', '700italic', '900', '900italic' ],
		'subsets' : [ 'latin-ext', 'latin' ]
	  },
	  {
		'kind' : 'webfonts#webfont',
	  ...
	  },
	  {
		'kind' : 'webfonts#webfont',
		'family' : 'Ubuntu',
		'variants' : [ '300', '300italic', 'regular', 'italic', '500', '500italic', '700',
			'700italic' ],
		'subsets' : [ 'cyrillic', 'greek-ext', 'latin-ext', 'latin', 'greek', 'cyrillic-ext' ]
	  }, {
		'kind' : 'webfonts#webfont',
	...
	addCountries : function() {
	  ...
	  for (country in countries) {
		if (countries.hasOwnProperty(country)) {
		  this.$element.append('<option value="' + country + '">' + countries[country]
			  + '</option>');
		}
	  }
	  ...
	  for (country in countries) {
		if (countries.hasOwnProperty(country)) {
		  if (this.options.flags === true) {
			$options.append('<li><a tabindex="-1" href="#" data-option="' + country
				+ '"><i class="glyphicon bfh-flag-' + country + '"></i>' + countries[country]
				+ '</a></li>');
		  } else {
			$options.append('<li><a tabindex="-1" href="#" data-option="' + country + '">'
...
!function($) {
  ...
  BFHCurrencies.prototype = {
	...
	addBootstrapCurrencies : function() {
		...
		if (this.currencyList.hasOwnProperty(currency)) {
		  ...
		  if (this.options.flags === true) {
			$options.append('<li><a tabindex="-1" href="#" data-option="' + currency
				+ '"><i class="glyphicon bfh-flag-' + this.flag + '"></i>'
	  ...
	  if (value) {
		if (this.options.flags === true) {
		  ...
		  $toggle.html('<i class="glyphicon bfh-flag-' + this.flag + '"></i> '
			  + this.currencyList[value].label);
		} else {
	...
	displayCurrency : function() {
	  ...
	  if (this.options.flags === true) {
		this.$element.html('<i class="glyphicon bfh-flag-' + this.flag + '"></i>'
			+ this.currencyList[value].label);
	  } else {
...
!function($) {
  ...
  BFHDatePicker.prototype = {
	  ...
	  if (date === '' || date === 'today') {
		if (date === 'today') {
		  this.$element.find('input[type=text]').val(
			  this.formatDate(today.getMonth(), today.getFullYear(), today.getDate()));
		}
	...
	updateCalendar : function() {
	  ...
	  for (i = 1; i <= numDays; i = i + 1) {
		...
		if (lowerlimit
			&& (i < lowerday && month === lowermonth && year === loweryear || month < lowermonth || year < loweryear)) {
		  row += '<td data-day="' + i + '" class="off">' + i + '</td>';
		} else if (higherlimit
			&& (i > higherday && month === highermonth && year === higheryear
				|| month > highermonth || year > higheryear)) {
		  row += '<td data-day="' + i + '" class="off">' + i + '</td>';
		} else if (i === today.getDate() && month === today.getMonth()
	...
	select : function() {
	  ...
	  $parent.find('input[type=text]').val($datePicker.formatDate(month, year, day)).trigger(
		  'change');
  ...
  $(function() {
	...
	$('body')
		.on(
			'click.bfhdatepicker.data-api focus.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			toggle, BFHDatePicker.prototype.toggle).on(
			'click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			'.bfh-datepicker-calendar > table.calendar .month > .previous',
			BFHDatePicker.prototype.previousMonth).on(
			'click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			'.bfh-datepicker-calendar > table.calendar .month > .next',
			BFHDatePicker.prototype.nextMonth).on(
			'click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			'.bfh-datepicker-calendar > table.calendar .year > .previous',
			BFHDatePicker.prototype.previousYear).on(
			'click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			'.bfh-datepicker-calendar > table.calendar .year > .next',
			BFHDatePicker.prototype.nextYear).on(
			'click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			'.bfh-datepicker-calendar > table.calendar td:not(.off)',
			BFHDatePicker.prototype.select).on(
			'click.bfhdatepicker.data-api touchstart.bfhdatepicker.data-api',
			'.bfh-datepicker-calendar > table.calendar', function() {
			  return false;
			});
  });
...
!function($) {
  ...
  BFHFonts.prototype = {
	...
	addBootstrapFonts : function() {
	  ...
	  for (f in this.familyList) {
		if (this.familyList.hasOwnProperty(f)) {
		  $options.append('<li><a tabindex="-1" href="#" style=\'font-family: '
			  + this.familyList[f] + '\' data-option="' + f + '">' + f + '</a></li>');
		}
	  }
...
!function($) {
  ...
  BFHFontSizes.prototype = {
	...
	addBootstrapFontSizes : function() {
	  ...
	  for (s in this.fontSizesList) {
		if (this.fontSizesList.hasOwnProperty(s)) {
		  $options.append('<li><a tabindex="-1" href="#" data-option="' + s + '">'
			  + this.fontSizesList[s] + '</a></li>');
		}
	  }
  ...
  BFHGoogleFonts.prototype = {
	...
	addFonts : function() {
	  ...
	  for (f in this.familyList) {
		if (this.familyList.hasOwnProperty(f)) {
		  ...
		  this.$element.append('<option value="' + entry.font.family + '">' + entry.font.family
			  + '</option>');
		}
	  }
	...
	addBootstrapFonts : function() {
	  ...
	  for (f in this.familyList) {
		if (this.familyList.hasOwnProperty(f)) {
		  entry = this.familyList[f];
		  $options.append('<li><a tabindex="-1" href="#" style="background-position: 0 -'
			  + ((entry.i * 30) - 2) + 'px;" data-option="' + entry.font.family + '">'
			  + entry.font.family + '</a></li>');
		}
	  }
  ...
  BFHLanguages.prototype = {
		...
		for (i = 0; i < languages.length; i = i + 1) {
		  ...
		  if (language.indexOf('_') !== -1) {
			...
			this.$element.append('<option value="' + language + '">'
				...
				+ BFHCountriesList[languageArr[1]] + ')</option>');
		  } else {
			this.$element.append('<option value="' + language + '">'
	...
	addBootstrapLanguages : function() {
	  ...
	  if (available.length > 0) {
		...
		for (i = 0; i < languages.length; i = i + 1) {
		  ...
		  if (language.indexOf('_') !== -1) {
			languageArr = language.split('_');
			if (this.options.flags === true) {
			  $options.append('<li><a tabindex="-1" href="#" data-option="' + language
				  + '"><i class="glyphicon bfh-flag-' + languageArr[1] + '"></i>'
				  + BFHLanguagesList[languageArr[0]].toProperCase() + '</a></li>');
			} else {
			  $options.append('<li><a tabindex="-1" href="#" data-option="' + language + '">'
				  + BFHLanguagesList[languageArr[0]].toProperCase() + ' ('
				  + BFHCountriesList[languageArr[1]] + ')</a></li>');
			}
		  } else {
			this.$element.append('<option value="' + language + '">'
				+ BFHLanguagesList[language].toProperCase() + '</option>');
		...
		for (language in BFHLanguagesList) {
		  if (BFHLanguagesList.hasOwnProperty(language)) {
			$options.append('<li><a tabindex="-1" href="#" data-option="' + language + '">'
				+ BFHLanguagesList[language].toProperCase() + '</a></li>');
		  }
		}
	  }
	  ...
	  if (value.indexOf('_') !== -1) {
		...
		if (this.options.flags === true) {
		  $toggle.html('<i class="glyphicon bfh-flag-' + languageArr[1] + '"></i> '
			  + BFHLanguagesList[languageArr[0]]);
		} else {
	...
	displayLanguage : function() {
	  ...
	  if (value.indexOf('_') !== -1) {
		languageArr = value.split('_');
		if (this.options.flags === true) {
		  this.$element.html('<i class="glyphicon bfh-flag-' + languageArr[1] + '"></i> '
			  + BFHLanguagesList[languageArr[0]]);
		} else {
		  this.$element.html(BFHLanguagesList[languageArr[0]] + ' ('
			  + BFHCountriesList[languageArr[1]] + ')');
		}
	  } else {
  ...
  $(function() {
	$('body')
		.on(
			...
			'.bfh-phone', BFHPhone.prototype.change).on('change.bfhphone.data-api', '.bfh-country',
			BFHPhone.prototype.changeCountry);
  });
...
+function($) {
  ...
  var backdrop = '.bfh-selectbox-backdrop', toggle = '[data-toggle=bfh-selectbox]', BFHSelectBox = function(
	  element) {
  ...
  BFHSelectBox.prototype = {
	...
	keydown : function(e) {
	  ...
	  $('body').off('mouseenter.bfh-selectbox.data-api', '[role=option] > li > a',
	  ...
	  $('body').on('mouseenter.bfh-selectbox.data-api', '[role=option] > li > a',
		  BFHSelectBox.prototype.mouseenter);
	},
  ...
  $(document)
	  ...
	  .on(
		  'click.bfhselectbox.data-api focus.bfhselectbox.data-api touchstart.bfhselectbox.data-api',
		  toggle, BFHSelectBox.prototype.toggle)
	  .on('keydown.bfhselectbox.data-api', toggle + ', [role=option]',
...
!function($) {
  ...
  BFHStates.prototype = {
	...
	loadStates : function(country) {
	  ...
	  for (state in BFHStatesList[country]) {
		if (BFHStatesList[country].hasOwnProperty(state)) {
		  this.$element.append('<option value="' + BFHStatesList[country][state].code + '">'
	...
	loadBootstrapStates : function(country) {
	  var $input, $toggle, $options, value, state;
	  ...
	  for (state in BFHStatesList[country]) {
		if (BFHStatesList[country].hasOwnProperty(state)) {
		  $options.append('<li><a tabindex="-1" href="#" data-option="'
			  + BFHStatesList[country][state].code + '">' + BFHStatesList[country][state].name
			  + '</a></li>');
		}
	  }
...
!function($) {
  ...
  $(function() {
	...
	$('body')
		.on(
			'click.bfhtimepicker.data-api focus.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
			toggle, BFHTimePicker.prototype.toggle).on(
			'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
			'.bfh-timepicker-popover > table .hour > .previous',
			BFHTimePicker.prototype.previousHour).on(
			'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
			'.bfh-timepicker-popover > table .hour > .next', BFHTimePicker.prototype.nextHour).on(
			'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
			'.bfh-timepicker-popover > table .minute > .previous',
			BFHTimePicker.prototype.previousMinute).on(
			'click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
			'.bfh-timepicker-popover > table .minute > .next', BFHTimePicker.prototype.nextMinute)
		.on('click.bfhtimepicker.data-api touchstart.bfhtimepicker.data-api',
...
!function($) {
  ...
  BFHTimezones.prototype = {
	...
	loadTimezones : function(country) {
	  ...
	  for (timezone in BFHTimezonesList[country]) {
		if (BFHTimezonesList[country].hasOwnProperty(timezone)) {
		  this.$element.append('<option value="' + timezone + '">'
			  + BFHTimezonesList[country][timezone] + '</option>');
		}
	  }
	...
	loadBootstrapTimezones : function(country) {
	  ...
	  for (timezone in BFHTimezonesList[country]) {
		if (BFHTimezonesList[country].hasOwnProperty(timezone)) {
		  $options.append('<li><a tabindex="-1" href="#" data-option="' + timezone + '">'
			  + BFHTimezonesList[country][timezone] + '</a></li>');
		}
	  }
